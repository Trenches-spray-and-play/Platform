...
export const MOCK_TRENCHES: Record<string, TrenchData> = {
    'RAPID': {
        ...
        name: 'RAPID TRENCH',
        level: 'RAPID',
        minEntry: 5,      // $5 USD cap
        maxEntry: 1000,   // $1,000 USD cap
        entrySize: '$5 - $1,000',
        roiCap: '1.5x',
        roiMultiplier: 1.5,
        cadence: 'NO WAIT',
        reserves: '500K',
        participants: [
            { id: '1', handle: '@cryptoknight', beliefScore: 920, boostPoints: 150, entryAmount: 500, timeAgo: '2m', status: 'active', isTurn: true },
            { id: '2', handle: '@wagmi_girl', beliefScore: 880, boostPoints: 200, entryAmount: 300, timeAgo: '5m', status: 'active' },
            { id: '3', handle: '@solanarunner', beliefScore: 750, boostPoints: 100, entryAmount: 200, timeAgo: '12m', status: 'pending' },
            { id: '4', handle: '@paperhands', beliefScore: 400, boostPoints: 50, entryAmount: 50, timeAgo: '45m', status: 'exited' },
        ]
    },
    'MID': {
        id: 'mid-1',
        name: 'MID TRENCH',
        level: 'MID',
        minEntry: 100,     // $100 USD cap
        maxEntry: 10000,   // $10,000 USD cap
        entrySize: '$100 - $10,000',
        roiCap: '1.5x',
        roiMultiplier: 1.5,
        cadence: '3 DAYS',
        reserves: '1.2M',
        participants: [
            { id: '5', handle: '@diamond_hands', beliefScore: 1200, boostPoints: 300, entryAmount: 5000, timeAgo: '15m', status: 'active' },
            { id: '6', handle: '@alpha_seeker', beliefScore: 1100, boostPoints: 250, entryAmount: 2500, timeAgo: '22m', status: 'active' },
        ]
    },
    'DEEP': {
        id: 'deep-1',
        name: 'DEEP TRENCH',
        level: 'DEEP',
        minEntry: 1000,      // $1,000 USD cap
        maxEntry: 100000,    // $100,000 USD cap
        entrySize: '$1,000 - $100,000',
        roiCap: '1.5x',
        roiMultiplier: 1.5,
        cadence: '7 DAYS',
        reserves: '5M',
        participants: [
            { id: '7', handle: '@whale_watcher', beliefScore: 5000, boostPoints: 500, entryAmount: 50000, timeAgo: '1h', status: 'active' },
        ]
    }
};
